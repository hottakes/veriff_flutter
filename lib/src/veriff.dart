...
class Veriff {
  ...
  // Recovers a previous verification session result.
  Future<Result?> recoverLastResult() async {
    final Map? resultMap =
        await channel.invokeMethod(VERIFF_RECOVER_LAST_RESULT);
    return resultMap != null ? ResultParser().fromResultMap(resultMap) : null;
  }
}
