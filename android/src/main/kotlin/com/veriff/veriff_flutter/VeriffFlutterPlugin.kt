...
private const val COMMAND_RECOVER_LAST_RESULT = "recoverLastResult"
...
class VeriffFlutterPlugin : FlutterPlugin, MethodCallHandler, ActivityAware,
  ...
  private var resultMap: Map<String, Any?>? = null
        ...
        boundActivity?.let {
          if (call.arguments != null && call.arguments is Map<*, *>) {
            ...
            if (flutterConfiguration != null) {
              ...
              if (flutterConfiguration.vendorData != null) {
                configBuilder.vendorData(flutterConfiguration.vendorData)
              }
